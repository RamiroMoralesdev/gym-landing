  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-secondary">
      <div className="absolute inset-0 z-0">
        <img src="/muscular-person-training-with-weights-in-modern-gy.jpg" alt="Gym training" className="w-full h-full object-cover opacity-40" />
      </div>
